...
- **<span style="color:blue">Confluent Cloud</span>**
 Inside an environment, create a new network in the region that you want. Select Private Link as networking type.
- **<span style="color:blue">Confluent Cloud</span>**] Create inside your CC VPC, a PrivateLink Access. Save that com.amazonaws.vpce.<region>.xxxxxx name for later. It will take time.
